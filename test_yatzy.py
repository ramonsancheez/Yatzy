from refactor_yatzy import Yatzy
import pytest
...
def test_three_of_a_kind():
        ...
        assert 9 == Yatzy.three_of_a_kind([1,2,3,3,3])
...
def test_largeStraight():
        ...
        assert 20 == Yatzy.largeStraight([2,6,4,3,5])
        assert 0 == Yatzy.largeStraight([2,6,4,2,5])
        assert 0 == Yatzy.largeStraight([1,2,2,4,5])

@pytest.mark.Yatzy
def test_fullHouse():
        assert 18 == Yatzy.fullHouse([6,2,2,2,6])
        assert 18 == Yatzy.fullHouse([2,2,2,6,6])
        assert 18 == Yatzy.fullHouse([2,6,2,6,2])
        assert 13 == Yatzy.fullHouse([3,3,2,3,2])
